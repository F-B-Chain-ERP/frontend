...
export class HomeComponent implements AfterViewInit {
  ...
  readonly recentVouchers = [
    { code: 'PCB245', description: 'Chi thanh toán tiền lương tháng 6', amount: '1.842.500.000', statusClass: 'success', statusLabel: 'Đã duyệt' },
    { code: 'PTB118', description: 'Thu phí, lệ phí nộp ngân sách', amount: '326.000.000', statusClass: 'success', statusLabel: 'Đã duyệt' },
    { code: 'PCB246', description: 'Chi mua sắm thiết bị văn phòng', amount: '94.200.000', statusClass: 'warning', statusLabel: 'Chờ duyệt' },
    { code: 'UNB977', description: 'Ủy nhiệm chi nộp bảo hiểm xã hội', amount: '248.700.000', statusClass: 'warning', statusLabel: 'Chờ duyệt' },
    { code: 'PCB247', description: 'Chi công tác phí quý II', amount: '37.500.000', statusClass: 'muted', statusLabel: 'Bản nháp' },
  ];
