...
echo "  - Giao diện Web (HTTPS)   : https://erp-utt.duckdns.org/"
echo "  - API Backend (qua proxy) : https://erp-utt.duckdns.org/api/v1/auth/login"
echo ""
echo "Nếu chưa cài đặt SSL Let's Encrypt, vui lòng chạy:"
echo "  sudo bash /opt/ERP-UTT/frontend/deploy/scripts/04-setup-ssl.sh"
echo ""
echo "Kiểm tra nhanh:"
echo "  curl -I http://localhost/"
echo "  curl -I https://erp-utt.duckdns.org/"
echo "=========================================================="
